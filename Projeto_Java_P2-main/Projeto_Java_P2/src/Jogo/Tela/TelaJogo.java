...
public class TelaJogo {
    ...
    public void tela() throws IOException {
         backgorund = new ImageIcon(getClass().getResource("/Jogo/Imagems/BACKGROUND.png"));
        ...
        JButton atacar = new JButton(new ImageIcon(getClass().getResource("/Jogo/Imagems/BOTAOATACAR.png")));
        atacar.setBounds(10, 405, 150, 50);
        JButton correr = new JButton(new ImageIcon(getClass().getResource("/Jogo/Imagems/BOTAOCORRER.png")));
        correr.setBounds(170, 405, 150, 50);
        JButton curar = new JButton(new ImageIcon(getClass().getResource("/Jogo/Imagems/BOTAOCURAR.png")));
        curar.setBounds(330, 405, 150, 50);
        JButton especial = new JButton(new ImageIcon(getClass().getResource("/Jogo/Imagems/BOTAOESPECIAL.png")));
